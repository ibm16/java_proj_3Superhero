...
public class MovieApp
{
    public static void main(String[] args) {
        ...
        System.out.println("Full Name: " + bestMovie.getTitle());
        System.out.println("Power Score: " + bestMovie.getMaturityRating());
        System.out.println("Description: " + bestMovie.getDescription());
    }
}
